...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Nodsoft.Cutter.Server.Data.Models.Link", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Nodsoft.Cutter.Server.Data.Models.Role", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("Nodsoft.Cutter.Server.Data.Models.User", b =>
                {
                    b.Property<long>("Id")
                        .HasColumnType("bigint")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("Nodsoft.Cutter.Server.Data.Models.Link", b =>
                {
                    b.HasOne("Nodsoft.Cutter.Server.Data.Models.User", "CreatedBy")
                        .WithMany("Links")
            ...
            modelBuilder.Entity("RoleUser", b =>
                {
                    b.HasOne("Nodsoft.Cutter.Server.Data.Models.Role", null)
                        .WithMany()
                    ...
                    b.HasOne("Nodsoft.Cutter.Server.Data.Models.User", null)
                        .WithMany()
